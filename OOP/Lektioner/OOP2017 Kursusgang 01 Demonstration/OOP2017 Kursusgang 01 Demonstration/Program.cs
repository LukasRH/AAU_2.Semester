...
namespace Kursusgang_01
{
    ...
    {
        /* 
         * Typer (klasser) kan have 'metoder', det svarer til funktioner fra C
    ...
    decimal: {2}", f, df, d);
        ...
        static void Fejlhåndtering()
        {
            ...
            finally // finally-blocken bliver altid kørt!
            {
                ...
                Console.WriteLine("Jeg bliver altid kørt!");
            }
        ...
        static void SelektiveKontrolstrukturer()
        {
            ...
            switch (K)
            {
                case Kørekorttype.AM:
                    break;
                case Kørekorttype.A1:
                    break;
                case Kørekorttype.A2:
                    break;
                case Kørekorttype.A:
                    break;
                case Kørekorttype.B1:
                    break;
                case Kørekorttype.B:
                    break;
                case Kørekorttype.C1:
                    break;
                case Kørekorttype.C:
                    break;
                case Kørekorttype.D1:
                    break;
                case Kørekorttype.D:
                    break;
                case Kørekorttype.BE:
                    break;
                case Kørekorttype.C1E:
                    break;
                case Kørekorttype.CE:
                    break;
                case Kørekorttype.D1E:
                    break;
                case Kørekorttype.DE:
                    break;
                default:
                    break;
            }
        ...
        static void IteratriveKontrolstrukturer()
        {
            ...
            /* 
             * Jeg kan iterere igennem alle tegn i en streng!
             */

            foreach (char ch in "C# er fedt!")
            {
